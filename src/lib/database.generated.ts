...
live_sessions: { Row: { id: string; location_id: string; quotation_id: string; studio_id: string; lane: number; work_date: string; start_hour: number; end_hour: number; host_id: string | null; host_fee: number | null; status: string; created_by: string; created_at: string; host_published: boolean; live_code: string; live_label: string; legacy_live_id: string }; Insert: never; Update: never; Relationships: [] };
