...
production_quotations: { Row: { id: string; location_id: string | null; reference: string; brand: string; account: string; platform: string; period_start: string; period_end: string; hours: number; rate: number; best_hours: (number)[]; created_by: string; created_at: string; brand_id: string | null; best_hour_slots: Json }; Insert: never; Update: never; Relationships: [] };
